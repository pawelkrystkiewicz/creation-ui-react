...
describe('Input', () => {
  ...
  it('renders with different input types', () => {
    ...
    types.forEach(type => {
      const { container } = render(<Input type={type} placeholder={`${type} input`} />)
  ...
  it('renders with date input types', () => {
  ...
  it('handles readOnly state', () => {
    const { getByRole } = render(<Input readOnly placeholder="ReadOnly input" />)
    const input = getByRole('textbox')
  ...
  it('handles onClear functionality', () => {
    const { getByTestId } = render(
      <Input 
        onClear={() => {}} 
        value="Test value"
  ...
  it('renders with color input type', () => {
  ...
  it('applies focus outline styles', async () => {
    const { getByRole } = render(<Input placeholder="Focus test" />)
    const input = getByRole('textbox')
    expect(input).toBeDefined()
