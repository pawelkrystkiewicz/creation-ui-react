/**
 * This is @tailwind/forms core code as of 20.04.2023.
 *
 *  It used like this because it is not compiling while using
 * it as a plugin unless declared in tailwind.config.js of hosting app
 *
 */
