...
<Tabs items={SCRIPTS_TABS}>
  ...
  <Tab>
    ```bash copy
     npm i add @creation-ui/react
     ```
     </Tab>
  <Tab>
    ```bash copy
     pnpm i add @creation-ui/react
     ```
     </Tab>
</Tabs>
...
<button className='bg-primary hover:bg-success-300 text-info-100 hover:text-info-900 rounded-md px-3 py-1'>
  Click me
</button>
