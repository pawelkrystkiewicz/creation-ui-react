...
import { CustomChip, properties, ChipPlayground, ChipAdornmentsExamples } from '@examples/chip'
...
<PropsTable properties={properties} name='Chip' description='Chip component props' />
