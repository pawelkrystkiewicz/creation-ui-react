import { TextAreaExample, properties, PasswordExample, TextAreaPlayground } from '@components/examples/textarea'
import { Container } from '@components/container'
import { UnfoldVariants } from '@components/unfold-variants'
import { ELEMENT_SIZES, ELEMENT_STATUS, TextArea } from '@creation-ui/react'
...
<Container column>
  <TextArea resize={'vertical'} label='Resizeable textarea Y' placeholder='You can resize me in Y' />
</Container>
<Container column>
  <TextArea resize={'horizontal'} label='Resizeable textarea X' placeholder='You can resize me in X' />
</Container>
...
<PropsTable
  ...
  description={
    <>
      The rest of the props are the same as for the native <code>textarea</code> component.
    </>
  }
/>
