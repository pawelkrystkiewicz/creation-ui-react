...
import { InputExample, properties, PasswordExample, InputPlayground, InputWidthsExample } from '@examples/input'
...
<Container>
  <PasswordExample label='Password' helperText='You can toggle my visibility' value='this-is-my-password' />
</Container>
