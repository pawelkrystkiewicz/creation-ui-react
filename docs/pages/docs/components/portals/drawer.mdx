...
import { DrawerPlayground, DrawerCustomizedExample, properties } from '@examples/drawer'
...
<PropsTable properties={properties} name='Drawer' description='Drawer component props.' />
