---
sidebarTitle: renderOption
---

import { renderOptionProps } from '@/examples/shared-props'
...
See [Highlighter](../highlighter) for more details on how to highlight search term.
