...
import {
  ...
  AutocompleteMultiplePlayground,
  AutocompleteExternalSearchValueExample,
} from '@/examples/autocomplete/index'
import PropsTable from '@/components/props-table'
import { defaultOptionType } from '@/examples/shared-props'
...
<b>Caveat</b>
When is cleared by default clearable callback the event will be synthetic and
will not contain the actual value.
