...
const features: Feature[] = [
  {
    ...
    description:
      'Build complex interfaces by combining simple, focused components. Each piece works independently and together.',
  },
  {
    icon: (
      <svg
    ...
    description:
      'CSS variables and Tailwind integration make customization effortless. Match your brand in minutes, not days.',
  },
  {
    icon: (
      <svg
  ...
  },
  {
    ...
    description:
      'Lightweight and tree-shakeable. Only ship the code you use. No hidden performance costs.',
  },
  {
    icon: (
      <svg
    ...
    description:
      'Full type safety with intelligent autocomplete. Catch errors at build time, not in production.',
  },
  {
    icon: (
      <svg
    ...
    description:
      'Same design tokens and patterns. Mix and match with your existing shadcn components seamlessly.',
  },
]
    ...
    <section className='relative py-24 px-4'>
      ...
      <div className='max-w-3xl mx-auto text-center mb-16'>
        ...
        <p className='text-lg text-muted-foreground max-w-2xl mx-auto'>
          Every component is crafted with precision, from pixel-perfect visuals
          to thoughtful API design. No compromises.
        </p>
      </div>
