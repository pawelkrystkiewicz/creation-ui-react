...
export const Docs = () => (
  <div className='h-screen-nextra-last w-full flex flex-col items-center snap-start'>
    ...
    <div className='max-w-md prose text-base leading-relaxed dark:text-white'>
      <p>
        Unleash your creativity and bring your vision to life with this powerful
        tool. The possibilities are endless, allowing you to transform ideas
        into reality.
      </p>
      <p>
        ...
        ease. It is time to take the first step and embark on a journey and tell
        your own story.
      </p>
